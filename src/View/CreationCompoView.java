...
public class CreationCompoView extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jComboBox3.setToolTipText("Type d'exercice à créer (les DMs et DSs sont regroupés)");
        ...
        newTitleTextField.setText(" ... nom_du_dossier ...");
        newTitleTextField.setToolTipText("Nom du dossier qui va contenir le nouvel exercice. Ce dernier ne doit pas contenir d'espaces ni de caractères spéciaux");
